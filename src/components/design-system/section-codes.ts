...
export const practicalGuideCode = `import { CheckCircle, ClipboardCheck, FolderDown, Link2 } from "lucide-react";
import { Button } from "@/components/ui/button";
...
const steps = [
  {
    ...
    description:
      "First and foremost you need to get familiar with the requirements and check your data availability:",
    items: [
      "Learn which of your product categories apply to ESPR",
      "Look at the timeline you need to follow and monitor for updates.",
      "Note all the datapoints that you need to collect, identify and fill gaps.",
      "Identify if any changes are needed to your product designs or supply chain to meet all requirements.",
    ],
  },
  {
    number: "02",
    ...
    description:
      "Second step of the process involves mapping your data and designing a schema for collection.",
    items: [
      "Map all the data needed for the DPP, how, and where do you collect it.",
      "Physical data collection should turn digital (at least spreadsheets).",
      "Repairability information",
      "Collaborate with suppliers to trace the necessary data.",
    ],
  },
  {
    number: "03",
    icon: Link2,
    title: "Implement & Distribute",
    description:
      "Last but not least you need to design a system that operates with all this data and creates functional compliant DPPs.",
    items: [
      "Develop all necessary features from data collection, through DPP formatting, to upload and future modification",
      "Align with all required standards from the EU (security, interoperability, resiliency, etc).",
      "Design connections to your information systems and tools to collect data from suppliers.",
      "Integrate your DPPs with the central EU database.",
    ],
  },
];
  ...
  return (
    <section className="py-24 sm:py-32 bg-background">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-3xl font-bold tracking-tight text-foreground sm:text-4xl">
            Practical Guide to DPPs
          </h2>
          <p className="mt-6 text-lg text-muted-foreground leading-relaxed">
            In order to get familiar with ESPR Digital Product Passports and
            integrate them into your supply chain in a compliant and strategic
            manner, a phased approach is necessary:
          </p>
        </div>
...
export const batteryPassportOverviewCode = `import { Settings, ShoppingCart, Users, Landmark } from "lucide-react";
...
const stakeholders = [
  {
    ...
    title: "Manufacturers",
    description:
      "Are responsible for collecting necessary information and assembling the dbp.",
  },
  {
    icon: ShoppingCart,
    title: "Customers",
    description:
      "Use the dbp to take informed purchase decisions and learn how to handle the product.",
  },
  {
    icon: Users,
    title: "Other Stakeholders",
    description:
      "Relevant stakeholders benefits form centralized access appropriate levels of information.",
  },
  {
    icon: Landmark,
    title: "Governments",
    description:
      "Establish the dbp requirements and infrastructure and use it as an access point of compliance surveillance.",
  },
];
    ...
    <section className="py-24 sm:py-32 bg-background">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="mt-2 text-3xl font-bold tracking-tight text-foreground sm:text-4xl">
            The Battery Passport as a Digital Product Passport
          </h2>
          <p className="mt-6 text-base text-muted-foreground leading-relaxed sm:text-lg">
            Battery passports are a form of Digital Product Passport, outlined
            in the new 2023 Battery regulation. They are facilitators of
            compliance reporting and supply chain traceability, as well as a
            digital archive of information for end consumers and vendors.
          </p>
        </div>
